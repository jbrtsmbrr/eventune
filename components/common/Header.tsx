...
const Header = () => {
  return (
    <div className="fixed top-0 z-50 flex items-center w-full p-4 py-2 justify-evenly bg-[#000000] text-gray-100 bg-opacity-10 backdrop-blur-3xl">
      <Link href="/">
        <div className="flex items-center gap-4">
          <Image alt="eventune-logo" src="/assets/icons/eventune-high-resolution-logo-white-transparent.png" width={45} height={45} />
          <p className="text-white font-bold font-serif tracking-widest text-sm hidden lg:block">eventune.</p>
        </div>
      </Link>
