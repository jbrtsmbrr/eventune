...
const ArtistsPage = () => {
  ...
  return (
    <div>
      <div className='sticky top-0 left-0 h-screen w-screen '>
        <div className='absolute h-full w-full bg-[url(/assets/images/artists/melanie-van-leeuwen-vu3cYpSsB9U-unsplash.jpg)] bg-cover bg-center bg-no-repeat ' />
        <div style={{ backdropFilter: `blur(${yOffset * 0.04}px)` }} className='absolute top-0 h-full w-full bg-purple-700 bg-opacity-10'>

        </div>
      </div>
      <div className='relative w-2/3 left-1/2 -translate-x-1/2 -translate-y-20 grid grid-cols-4 h-[400px] gap-8'>
