      ...
      <div className='w-full'>
        <div className='h-screen xl:w-4/5 w-2/3 z-10 flex items-center mx-auto justify-center relative md:flex-row flex-col md:gap-8 py-8 box-border'>
          ...
          <div className="flex-1 h-2/3 w-full flex flex-col items-center justify-center gap-8 backdrop-blur-2xl p-8 border border-white border-opacity-20 bg-black bg-opacity-45">
            <div>
              <p className="text-3xl md:text-5xl lg:text-6xl text-center text-white drop-shadow-md tracking-tighter font-extrabold">
                {event.name}
              </p>
            </div>
            <div>
            ...
            <div className='flex gap-4 items-center'>
              <div className='border border-dashed border-gray-200 hover:border-gray-300 p-3 px-4 bg-white bg-opacity-15 cursor-pointer'>
              ...
              <div className='border border-dashed border-gray-500 hover:border-gray-300 p-3 px-4 bg-gray-50 bg-opacity-5 cursor-pointer'>
            ...
            <form action={onCheckout} method="post" className='flex gap-4 items-center'>
              {/* <div>
